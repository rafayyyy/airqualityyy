...
SoftwareSerial BLE_HM10(11,10);// TX RX
...
void setup() {
  ...
  */
  ...
  /*****************************  MQ CAlibration ********************************************/ 
  Serial.println("|   CO   |   Alcohol   |   CO2   |   Tolueno   |   NH4   | Acteona | Temperature | Humidity ");  
}
...
void loop() {
  ...
  */
  Serial.print("   |   "); Serial.print(CO2); //add 400
